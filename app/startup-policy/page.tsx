      ...
      <section className="relative py-20 bg-gradient-to-b from-[#0B0D12] via-[#0f1117] to-[#141824] overflow-hidden border-b border-slate-800/80">
        ...
        <div className="container mx-auto px-4 lg:px-6 relative z-10 text-center max-w-4xl space-y-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-white tracking-tight">
            Startup <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6CBD45] via-emerald-400 to-lime-300">Policy</span>
          </h1>
          <p className="text-slate-400 text-sm font-mono">Effective Date: January 2025 • Quantum University Incubation Guidelines</p>
        </div>
      </section>
              ...
              <CardContent className="p-8 sm:p-12 space-y-8">
                <section className="space-y-3">
                  <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                    <span className="text-[#6CBD45]">1.</span> Overview
                  </h2>
                  <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
                    This policy establishes the operational rules for incubatees, pre-incubation cohorts, faculty spin-offs, and student founders supported by Genesis - QUIC.
                  </p>
                </section>

                <section className="space-y-3 pt-6 border-t border-slate-800/80">
                  <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                    <span className="text-[#6CBD45]">2.</span> Cohort Eligibility
                  </h2>
                  <ul className="list-disc list-inside text-slate-400 space-y-2 text-sm sm:text-base pl-2">
                    <li>Idea to growth-stage startups with tech innovation or scalability.</li>
                    <li>Committed founder team willing to engage in weekly mentorship check-ins.</li>
                    <li>Strict adherence to ethical, technical, and safety standards.</li>
                  </ul>
                </section>

                <section className="space-y-3 pt-6 border-t border-slate-800/80">
                  <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                    <span className="text-[#6CBD45]">3.</span> Resource Allocation & Grants
                  </h2>
                  <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
                    Selected startups receive co-working desks, high-speed connectivity, cloud credits, laboratory support, and eligibility for grant funding up to ₹25 Lakhs based on performance milestone reviews.
                  </p>
                </section>

                <section className="space-y-3 pt-6 border-t border-slate-800/80">
                  <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                    <span className="text-[#6CBD45]">4.</span> Contact Incubator Office
                  </h2>
                  <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                    For policy clarification:
                    <br />
                    <span className="text-[#6CBD45] font-mono">Email: policy@genesis-quic.in</span>
                    <br />
