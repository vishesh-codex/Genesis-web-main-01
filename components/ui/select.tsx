...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "bg-slate-900/90 border-slate-800 text-white focus:border-[#6CBD45] focus:ring-1 focus:ring-[#6CBD45]/30 flex h-10 w-full items-center justify-between gap-2 rounded-xl border px-3.5 py-2 text-sm shadow-sm transition-all outline-none disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    >
